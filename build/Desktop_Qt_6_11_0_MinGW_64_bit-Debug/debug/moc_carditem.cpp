...
template <> constexpr inline auto CardItem::qt_create_metaobjectdata<qt_meta_tag_ZN8CardItemE_t>()
{
    ...
    QtMocHelpers::UintData qt_methods {
        // Signal 'cardClicked'
        QtMocHelpers::SignalData<void(CardType)>(1, 2, QMC::AccessPublic, QMetaType::Void, {{
            { 0x80000000 | 3, 4 },
        }}),
    };
...
void CardItem::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        switch (_id) {
        case 0: _t->cardClicked((*reinterpret_cast<std::add_pointer_t<CardType>>(_a[1]))); break;
        default: ;
        }
    }
    if (_c == QMetaObject::IndexOfMethod) {
        if (QtMocHelpers::indexOfMethod<void (CardItem::*)(CardType )>(_a, &CardItem::cardClicked, 0))
            return;
    }
}
...
// SIGNAL 0
void CardItem::cardClicked(CardType _t1)
{
