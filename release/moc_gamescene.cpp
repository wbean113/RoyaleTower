...
template <> constexpr inline auto GameScene::qt_create_metaobjectdata<qt_meta_tag_ZN9GameSceneE_t>()
{
    ...
    QtMocHelpers::UintData qt_methods {
        ...
        // Slot 'onCardClicked'
        QtMocHelpers::SlotData<void(CardType)>(7, 2, QMC::AccessPublic, QMetaType::Void, {{
            { 0x80000000 | 8, 9 },
        }}),
        // Slot 'updateCardCooldowns'
        QtMocHelpers::SlotData<void()>(10, 2, QMC::AccessPublic, QMetaType::Void),
        // Slot 'clearSpellEffects'
...
void GameScene::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->addResource(); break;
        case 2: _t->spawnEnemy(); break;
        case 3: _t->updateGame(); break;
        case 4: _t->gameover(); break;
        case 5: _t->onCardClicked((*reinterpret_cast<std::add_pointer_t<CardType>>(_a[1]))); break;
        case 6: _t->updateCardCooldowns(); break;
        case 7: _t->clearSpellEffects(); break;
        default: ;
        }
    }
    if (_c == QMetaObject::IndexOfMethod) {
        if (QtMocHelpers::indexOfMethod<void (GameScene::*)()>(_a, &GameScene::requestBackToMenu, 0))
            return;
    }
}
...
// SIGNAL 0
void GameScene::requestBackToMenu()
{
